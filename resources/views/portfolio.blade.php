...
<body id="page-top">
  ...
  <nav class="navbar navbar-b navbar-trans navbar-expand-md fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll" href="{{ route('index') }}">Hankusa</a>
      ...
      <div class="navbar-collapse collapse justify-content-end" id="navbarDefault">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link js-scroll active" href="#home">Portfolio</a>
          </li>
        </ul>
      </div>
    </div>
    ...
    <section id="work" class="portfolio-mf sect-pt4 route">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="work-box">
              <a href="{{ asset('https://hankusa.me/static/8333dff9379870266dcd12b5dbf7421c/619b4/work-1.avif') }}" data-gall="portfolioGallery" class="venobox">
                <div class="work-img">
                  <img src="{{ asset('https://hankusa.me/static/8333dff9379870266dcd12b5dbf7421c/619b4/work-1.avif') }}" alt="" class="img-fluid">
                </div>
              </a>
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-12">
                    <h2 class="w-title">TuguRe</h2>
                    <div class="w-more">
          ...
          <div class="col-md-4">
            <div class="work-box">
              <a href="{{ asset('https://hankusa.me/static/efb3112f2a3ca2d9b8c91700a7ccfd5d/619b4/work-2.avif') }}" data-gall="portfolioGallery" class="venobox">
                <div class="work-img">
                  <img src="{{ asset('https://hankusa.me/static/efb3112f2a3ca2d9b8c91700a7ccfd5d/619b4/work-2.avif') }}" alt="" class="img-fluid">
                </div>
              </a>
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-12">
                    <h2 class="w-title">Suburputra Store</h2>
                    <div class="w-more">
                      <span class="w-ctegory"></span>
                    </div>
                  </div>
          ...
          <div class="col-md-4">
            <div class="work-box">
              <a href="{{ asset('https://hankusa.me/static/ff338556cf9161d88193ab73cf1ad5a1/619b4/work-3.avif') }}" data-gall="portfolioGallery" class="venobox">
                <div class="work-img">
                  <img src="{{ asset('https://hankusa.me/static/ff338556cf9161d88193ab73cf1ad5a1/619b4/work-3.avif') }}" alt="" class="img-fluid">
                </div>
              </a>
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-12">
                    <h2 class="w-title">Handy Resto</h2>
                    <div class="w-more">
                      <span class="w-ctegory"></span>
                    </div>
                  </div>
